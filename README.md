...
[x] Write a function `createCharacterCard` inside the `card.js` file and export it.
[x] You can use `innerHTML` to generate the HTML of the card. Cut the relevant HTML code of the card
...
[x] Inside of the `index.js` create a function called `fetchCharacters`.
